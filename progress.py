...
"""
        ...
        html = html.replace(
            "prev.onclick=()=>loadPage(Number(pageInput.value)-1);next.onclick=()=>loadPage(Number(pageInput.value)+1);",
            "prev.onclick=()=>navigateProgressPage(Number(pageInput.value)-1);next.onclick=()=>navigateProgressPage(Number(pageInput.value)+1);",
            1,
        )
