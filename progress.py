...
"""
        ...
        new_load_start = "pageInput.value=n;selectedTarget=null;selectionPulse=0;selectionAnimationToken++;delete canvas.dataset.selectedTarget;updateProgressThumbActive();setBusy(true);drawingZoom=1;zoomReset.textContent='100%';canvas.style.width='100%';resetPosition();"
