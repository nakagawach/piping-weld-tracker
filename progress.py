...
"""
        ...
        old_load_start = "pageInput.value=n;setBusy(true);desktopFitMode=isWideDesktop();drawingZoom=1;rotation=0;zoomReset.textContent=desktopFitMode?'Fit ⛶':'100%';rotateButton.textContent='↻ 0°';canvas.style.width='100%';resetPosition();"
        new_load_start = "pageInput.value=n;selectedTarget=null;selectionPulse=false;delete canvas.dataset.selectedTarget;updateProgressThumbActive();setBusy(true);desktopFitMode=isWideDesktop();drawingZoom=1;rotation=0;zoomReset.textContent=desktopFitMode?'Fit ⛶':'100%';rotateButton.textContent='↻ 0°';canvas.style.width='100%';resetPosition();"
