...
def create_responsive_header_blueprint():
    ...
    def apply_responsive_header(response):
        ...
        if "</head>" not in html or "</body>" not in html or "data-responsive-header-v5" in html:
            return response
...
@media(max-width:820px){
  ...
  body.weld-progress-v5 main{padding:0!important;max-width:none!important}
  body.weld-progress-v5 .top{display:none!important}
  body.weld-progress-v5 .card{border:0!important;border-radius:0!important}
  body.weld-progress-v5 .toolbar{position:sticky!important;top:var(--weld-appbar-h)!important;z-index:60!important;height:auto!important;min-height:48px!important;display:flex!important;flex-wrap:wrap!important;align-items:center!important;gap:3px!important;padding:4px max(6px,env(safe-area-inset-right)) 4px max(6px,env(safe-area-inset-left))!important;white-space:normal!important;background:#fff!important;border-bottom:1px solid #eee!important}
  body.weld-progress-v5 .toolbar>.spacer,body.weld-progress-v5 .toolbar>.desktop-tools,body.weld-progress-v5 .toolbar>.compact-fullscreen,body.weld-progress-v5 .toolbar>.more{display:none!important}
  body.weld-progress-v5 .weld-page-nav-group{display:flex;align-items:center;gap:2px;flex:0 1 auto;min-width:0}
  body.weld-progress-v5 .weld-action-group{display:flex;align-items:center;justify-content:flex-end;gap:2px;flex:1 1 auto;min-width:0}
  body.weld-progress-v5 .weld-page-nav-group .nav-button{min-width:38px!important;min-height:40px!important;padding:0 5px!important;border:0!important;background:transparent!important;font-size:1.35rem!important}
  body.weld-progress-v5 .weld-page-nav-group .page-field{gap:2px!important;min-width:0!important}
  body.weld-progress-v5 .weld-page-nav-group .page-field>span:first-child{display:none!important}
  body.weld-progress-v5 .weld-page-nav-group .page-field input{width:40px!important;min-height:38px!important;border:0!important;border-radius:9px!important;background:#f3f4f6!important;font-weight:800!important;padding:0 3px!important}
  body.weld-progress-v5 .weld-page-nav-group .page-total{font-size:.78rem!important;color:#6b7280!important}
  body.weld-progress-v5 .weld-action-group>.button{min-width:40px!important;width:40px!important;min-height:40px!important;padding:0!important;border:0!important;border-radius:10px!important;background:transparent!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;font-size:1.1rem!important}
  body.weld-progress-v5 .weld-action-group>.page-favorite-view{font-size:1.4rem!important}
  body.weld-progress-v5 .weld-action-group>.compact-rotate{display:inline-flex!important}
  body.weld-progress-v5 .statusline{display:none!important}
}

@media(max-width:390px) and (orientation:portrait){
  body.weld-progress-v5 .toolbar{align-items:stretch!important;row-gap:2px!important}
  body.weld-progress-v5 .weld-page-nav-group{flex:1 1 100%;justify-content:center}
  body.weld-progress-v5 .weld-action-group{flex:1 1 100%;justify-content:center;gap:14px}
  body.weld-progress-v5 .viewer{max-height:calc(100dvh - var(--weld-appbar-h) - 92px - 31px - 62px)!important;min-height:calc(100dvh - var(--weld-appbar-h) - 92px - 31px - 62px)!important}
}

@media(min-width:391px) and (max-width:820px){
  body.weld-progress-v5 .toolbar{flex-wrap:nowrap!important}
  body.weld-progress-v5 .viewer{max-height:calc(100dvh - var(--weld-appbar-h) - 48px - 31px - 62px)!important;min-height:calc(100dvh - var(--weld-appbar-h) - 48px - 31px - 62px)!important}
}

@media(max-width:820px) and (orientation:landscape){
  .weld-appbar-title small{display:none}
  body.weld-progress-v5 .summary{height:31px!important;padding:3px 6px!important}
  body.weld-progress-v5 .progress-thumbs{height:62px!important;padding:3px 5px!important}
  body.weld-progress-v5 .progress-thumb{flex-basis:66px!important}
...
@media(max-width:820px){
  ...
  body.weld-simple-header-v5 .top{display:flex!important;align-items:center!important;justify-content:flex-start!important;gap:8px!important;background:#fff!important;border-bottom:1px solid #e5e5e5!important;padding:5px max(8px,env(safe-area-inset-right)) 5px max(8px,env(safe-area-inset-left))!important;margin:0 0 8px!important;position:sticky!important;top:0!important;z-index:50!important}
  body.weld-simple-header-v5 .top>#back{order:-10!important;flex:0 0 auto!important;width:auto!important;min-width:40px!important;min-height:40px!important;padding:0 8px!important;border:0!important;background:transparent!important;color:#174ea6!important}
  body.weld-simple-header-v5 .top>#back .weld-back-label{display:none!important}
  body.weld-simple-header-v5 .top>div:first-of-type{min-width:0!important;flex:1 1 auto!important}
  body.weld-simple-header-v5 .top .title{white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
  body.weld-simple-header-v5 .top .meta,body.weld-simple-header-v5 .top .sub{white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
}
</style>
"""
        ...
        if progress_match:
            script = """
<script data-responsive-header-v5>
(() => {
  ...
  window.addEventListener('pagehide',()=>{document.removeEventListener('pointerdown',closeMoreOutside,true);document.removeEventListener('keydown',closeMoreEscape);observer.disconnect()},{once:true});
})();
</script>
"""
...
(() => {
  ...
  document.body.classList.add('weld-simple-header-v5');
