...
def main():
    ...
    try:
        with sync_playwright() as p:
            ...
            # iPad landscape: adaptive right panel within its min/max bounds.
            ...
            assert panel and 278<=panel["width"]<=362,panel
            ...
            # Large portrait tablet: adaptive bottom boundary follows the width-fitted drawing.
            ...
            # 768px portrait iPad/tablet: adaptive bottom boundary.
